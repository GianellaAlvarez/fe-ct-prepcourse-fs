...
function obtenerMayor(x, y) {
   ...
   else return "No ingresaste un número"
}
console.log(obtenerMayor(55, 4))
console.log(obtenerMayor(5, 14))
console.log(obtenerMayor(55, 55))
...
console.log(operadoresLogicos(50,10,85))
...
console.log(tieneTresDigitos(56))
